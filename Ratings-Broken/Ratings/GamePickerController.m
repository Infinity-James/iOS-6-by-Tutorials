...
- (void)viewDidLoad
{
	...
	_games				= [NSArray arrayWithObjects:@"Angry Birds", @"Battleship", @"Checkers", @"Chess", @"Halo", @"Monopoly", @"Plays with Themselves", @"Russian Roulette", @"Spin the Bottle", @"Texas Hold'em Poker", @"Tic-tac-Toe", nil];
